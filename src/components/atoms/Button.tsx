...
const Button: React.FC<ButtonProps> = ({id, name, price, image, handleAddToCart}) => {
    return ( 
        <button 
            ...
            className="py-1.5 px-3 bg-green-300 rounded-lg font-medium shadow-md hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75"
        >
            Add to cart
        </button>
     );
